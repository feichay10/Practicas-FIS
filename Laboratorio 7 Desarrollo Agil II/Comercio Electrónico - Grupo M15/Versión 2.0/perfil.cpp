...
float Perfil::get_wallet_balance()
{
  return wallet_balance_;
}

int Perfil::get_num_product()
{
  return num_product_;
}

int Perfil::get_num_sell()
{
  return num_sell_;
}

void Perfil::set_ID(int id)
{
  ID_ = id;
}

void Perfil::set_nick_name(std::string n)
{
  nick_name_ = n;
}

void Perfil::set_password(std::string n)
{
  password_ = n;
}

void Perfil::set_email(std::string n)
{
  email_ = n;
}

void Perfil::set_phone(int i)
{
  phone_ = i;
}

void Perfil::set_address(std::string n)
{
  address_ = n;
}

void Perfil::set_wallet_balance(float i)
{
  wallet_balance_ = i;
}

void Perfil::set_num_product(int i)
{
  num_product_ = i;
}

void Perfil::set_num_sell(int i)
{
  num_sell_ = i;
}
...
bool Perfil::check_passwd(std::string passwd)
{
...
void Perfil::num_product_add1()
{
  num_product_++;
}

void Perfil::num_sell_add1()
{
  num_sell_++;
}